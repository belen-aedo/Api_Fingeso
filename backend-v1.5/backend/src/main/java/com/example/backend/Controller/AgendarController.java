...
public class AgendarController {
    ...
    public List<VehiculoReferencia> getAllVehiculosAvailable(
        ...
        try {
            List<Vehiculo> VehiculoDispo = vehiculoSearchService.ObtenerVehiculosDisponibles(fechaRetiro, fechaDevolucion,nombreSucursalRet) ;
            List<VehiculoReferencia> VehiculoReferencias = new LinkedList<>();
            return vehiculoSearchService.obtenerVehiculosReferencia(VehiculoDispo);
    ...
    public String RealizarAgendamiento(
        ...
        try {
            ...
            Vehiculo vehiculo = vehiculoSearchService.BuscarVehiculoPorPatente(patente);
