...
@CrossOrigin
public class ValidarDevolucion {
    ...
    @Autowired
    private VehiculoSearchService vehiculoSearchService;

    @Autowired
    private AgendarRerserva agendarRerservaService;
    ...
    public String ObtenerDatosArriendo(@RequestParam("NombreSucursal") String sucursalActual,
        ...
        try {
            ...
            if(rol.equals("gerente") || rol.equals("asalariado")) {
                ...
                Vehiculo vehiculo = vehiculoSearchService.ObtenerDatosDeVehiculos(idReserva); // busco el vehiculo vinculado al arriendo por el id de la reserva
    ...
    // ejemplo http://localhost:8080/api/Devolucion/confirmaDevolucion?EstadoPendiente=1&idReserva=4&rol=asalariado&multa=50000.0&idVehiculo=1&nuevoKilometraje=20300
