...
public class ValidacionDatos {
    ...
    // Getters and Setters
    public void setValidarDatoString(String CambiarDato) {
        this.ValidarDatoString = CambiarDato;
    }

    public void setValidarDatoFecha(LocalDate DatoFecha) {
        this.ValidarDatoFecha = DatoFecha;
    }
